 <footer id="footer">
 			...
 			<div class="row">
 				...
 				<div class="col-sm-3">
 					<div class="address">
 						...
 						<p>Universitas Pasundan Bandung , Bandung Indonesia</p>
 					</div>
 				</div>
 			</div>
 		</div>
 	...
 	<div class="footer-bottom">
 		<div class="container">
 			<div class="row">
 				<p class="pull-left">Copyright © 2019 A-Stro Inc. All rights reserved.</p>
 				<p class="pull-right">Designed by <span><a target="_blank" href="">University Of Pasundan Bandung</a></span></p>
 			</div>
 		</div>
 	</div>
